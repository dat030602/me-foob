...
class BranchController {
	...
	getMenu(req, res) {
		const func = async () => {
			try {
              ...
              CONVERT(VARCHAR(5), CN.ThoiGianDongCua,108) as 'ThoiGianDongCua', CN.TinhTrangChiNhanh,
              DT.MaDoiTac, CN.MaChiNhanh
	...
	//             .input("ThoiGianMoCua", req.body.ThoiGianMoCua)
	//             .execute("dbo.SP_UPDATE_THOIGIANMOCUA")
	//             .then((v) => {
	//               result = v;
	//             })
